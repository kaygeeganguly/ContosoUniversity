...
namespace ContosoUniversity.Controllers
{
    public class InstructorsController : BaseController
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public IActionResult Edit(int? id, [Bind("ID,LastName,FirstMidName,HireDate,OfficeAssignment")] Instructor updatedInstructor, string[]? selectedCourses)
        {
            if (id == null)
            {
                return BadRequest();
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    if (updatedInstructor.OfficeAssignment != null &&
                        String.IsNullOrWhiteSpace(updatedInstructor.OfficeAssignment.Location))
                    {
                        instructorToUpdate.OfficeAssignment = null;
                    }
                    else if (updatedInstructor.OfficeAssignment != null)
                    {
                        ...
                        instructorToUpdate.OfficeAssignment.Location = updatedInstructor.OfficeAssignment.Location;
                    }
